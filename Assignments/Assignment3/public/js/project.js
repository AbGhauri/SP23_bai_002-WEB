...
const userIcon = document.getElementById('userIcon'); // Assuming you'll add an ID 'userIcon' to your user icon element in HTML
const sidebarLogin = document.getElementById('sidebarLogin');
const closeLogin = document.getElementById('closeLogin');

if (userIcon && sidebarLogin && closeLogin) {
  userIcon.addEventListener('click', function() {
    sidebarLogin.classList.remove('translate-x-full');
  });

  closeLogin.addEventListener('click', function() {
    sidebarLogin.classList.add('translate-x-full');
  });
}
